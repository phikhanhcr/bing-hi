  ...
  <footer class="footer-area--01 footer-area--01--modifi">
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-3 col-xl-3 col-xxl-3 col-sm-6 col-xs-9 col-10 order-sm-1 order-lg-1">
          <div class="footer-content text-center text-sm-start">
            <a href="index.html" class="footer-content--logo d-block mb-0">
              <img src="/img/contentio/contentio-b-01.png"  style="max-width: 180px" alt="logo">
            </a>
            <p class="footer-content--text text-dark">Discover how to create a successful content marketing plan to help you reach your audience and boost conversions.</p>
      ...
      <div class="copyright-area">
        <p>© 2022 Custer All Rights Reserved.</p>
      </div>
    </div>
  </footer>