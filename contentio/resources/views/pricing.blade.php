                ...
                <div class="row justify-content-center">
                    <div class="col-xl-8 col-lg-8 col-md-10 col-sm-11 col-xs-11">
                        <div class="breadcrumb-section__content hero-content text-center">
                            <h1 class="heading-light title mb-20 text-light">Pricing</h1>
                            <h3 class="text-light mb-20 text-light">Organize your work with Contentio Premium</h2>
                            {{-- <p class="text-light">Quickly record your archievements and thoughts with messenger-styled notes.</p>
                            <p class="text-light">More functions. More peace of mind. Contentio Premium is a bit of your second brain (and more reliable)..</p>
                            <p class="text-light">Celebrate your progress. Trust the premium features of Contentio to help you manage your work, no matter how complex..</p>
                            <p class="text-light">More than 500,000 people rely on Contentio Premium to structure their work and personal life.</p> --}}
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb justify-content-center text-light">
                                    <li class="breadcrumb-item text-light text-light">Home</li>
                                    <li class="breadcrumb-item text-light text-light" aria-current="page">Pricing</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container">
                ...
                <div class="row three-row-mobile-slider mobile-slider justify-content-center align-items-center widgets-row"
                    ...
                    @foreach ($packages as $package)
                        <div class="col-md-{{ $width }} pricing__item item-package" style=""
                        ...
                        <div class="col-xl-10 col-md-10 co-xs-12 col-sm-12 col-12">
                            <div class="row justify-content-center">
                                <div style="width: 600px; margin: 30px auto 0 auto">
                                    <div class="text-center selected-package text-light" style="font-size: 20px; font-weight: bold">
                                        Please choose package
                                    </div>
                                    <div class="text-center text-light" style="margin-bottom: 20px">
                                    ...
                                    <div class="text-light">
                                        ...
                                        <a href="/terms-of-service" class="text-dark" target="_blank">Terms of Service</a>
                                        and acknowledge reading the
                                        <a href="/renewal-policy" target="_blank" class="text-dark">Renewal Policy</a>. You also agree
                                        to our <a href="/refund-policy" class="text-dark" target="_blank">Refund
                                            Policy</a> and auto renewal of your subscription, which can be disabled at any
                                        time through your
