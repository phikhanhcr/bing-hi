                ...
                <div class="row justify-content-center">
                    <div class="col-xl-8 col-lg-8 col-md-10 col-sm-11 col-xs-11">
                        <div class="breadcrumb-section__content hero-content text-center">
                            <h1 class="heading-light title mb-20 text-dark">Pricing</h1>
                            <h3 class="text-light mb-20 text-dark">Organize your work with Contentix Premium</h2>
                            {{-- <p class="text-light">Quickly record your archievements and thoughts with messenger-styled notes.</p>
                            <p class="text-light">More functions. More peace of mind. Contentix Premium is a bit of your second brain (and more reliable)..</p>
                            <p class="text-light">Celebrate your progress. Trust the premium features of Contentix to help you manage your work, no matter how complex..</p>
                            <p class="text-light">More than 500,000 people rely on Contentix Premium to structure their work and personal life.</p> --}}
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb justify-content-center text-dark">
                                    <li class="breadcrumb-item text-light text-dark">Home</li>
                                    <li class="breadcrumb-item text-light text-dark" aria-current="page">Pricing</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                            ...
                            <div class="row justify-content-center">
                                <div style="width: 600px; margin: 30px auto 0 auto">
                                    ...
                                    <div class="text-dark">
                                        ...
                                        <a href="/renewal-policy" target="_blank">Renewal Policy</a>. You also agree
                                        to our <a href="/refund-policy" target="_blank">Refund
