        ...
        <nav class="navbar site-navbar">
            ...
            <div class="site-header__brand">
                <a href="{{ route('getIndex') }}">
                    ...
                    <img src="./img/contentix/contentix-b-01.png" alt="" style="max-width: 180px;"
                        class="logo-white">
                    <!-- Dark version logo (logo must be White)-->
                    <img src="./img/contentix/contentix-w-01.png" alt="" style="max-width: 180px;"
                        class="logo-black">
                </a>
            </div>
                ...
                <nav class="menu-block menu-block-inner" id="append-menu-header">
                    ...
                    <ul class="site-menu-main">
                        <li class="nav-item nav-item-has-children">
                            <a href="{{ route('getIndex') }}" class="nav-link-item text-dark drop-trigger">Home
                            </a>

                        </li>
                        <li class="nav-item nav-item-has-children">
                            <a href="{{ route('getPricing') }}" class="nav-link-item text-dark drop-trigger">Pricing</a>
                        </li>
                        <li class="nav-item nav-item-has-children">
                            <a href="{{ route('getContact') }}" class="nav-link-item text-dark drop-trigger">Contact</a>
                        </li>
                    </ul>
                </nav>
