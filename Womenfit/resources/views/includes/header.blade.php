            ...
            <nav class="navbar site-navbar">
                ...
                <div class="site-header__brand">
                    <a href="{{ route('getIndex') }}">
                        ...
                        <img src="/img/period2/womenfit-b-01.png" style="max-width: 180px" alt="" class="logo-white">
                        <!-- Dark version logo (logo must be White)-->
                        <img src="/img/period2/womenfit-w-01.png" alt="" style="max-width: 180px" class="logo-black">
                    </a>
                </div>
