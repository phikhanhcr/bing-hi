                ...
                <div class="row justify-content-center">
                    <div class="col-xl-8 col-lg-8 col-md-10 col-sm-11 col-xs-11">
                        <div class="breadcrumb-section__content hero-content text-center">
                            <h1 class="heading-light title mb-20">Pricing</h1>
                            <h3 class="text-light mb-20">Organize your work with Womenfit Premium</h2>
                            {{-- <p class="text-light">Quickly record your archievements and thoughts with messenger-styled notes.</p>
                            <p class="text-light">More functions. More peace of mind. Womenfit Premium is a bit of your second brain (and more reliable)..</p>
                            <p class="text-light">Celebrate your progress. Trust the premium features of Womenfit to help you manage your work, no matter how complex..</p>
                            <p class="text-light">More than 500,000 people rely on Womenfit Premium to structure their work and personal life.</p> --}}
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb justify-content-center">
                                    <li class="breadcrumb-item text-light">Home</li>
                                    <li class="breadcrumb-item text-light" aria-current="page">Pricing</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
